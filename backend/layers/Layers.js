...
const Layers = [
  {
    ...
    description: 'Stream monitoring site water quality benchmark values for selected parameters and time period.',
    drawOrder: 50,
    legendOrder: -10,
    enabled: true,
    visible: true,
  ...
  },
  {
    ...
    description: 'Reservoir monitoring site water quality benchmark values for selected parameters and time period.',
    drawOrder: 50,
    legendOrder: -9,
    enabled: false,
    visible: false,
  ...
  },
  {
    ...
    description: 'Effluent monitoring site water quality benchmark values for selected parameters and time period.',
    drawOrder: 50,
    legendOrder: -8,
    enabled: false,
    visible: false,
  ...
  },
  {
    ...
    description:
      'Mine discharge monitoring site water quality benchmark values for selected parameters and time period.',
    drawOrder: 50,
    legendOrder: -7,
    enabled: false,
    visible: false,
  ...
  },
  {
    ...
    description: 'Spring monitoring site water quality benchmark values for selected parameters and time period.',
    drawOrder: 50,
    legendOrder: -6,
    enabled: false,
    visible: false,
  ...
  },
  {
    ...
    description: 'Groundwater monitoring site water quality benchmark values for selected parameters and time period.',
    drawOrder: 50,
    legendOrder: -5,
    enabled: false,
    visible: false,
  ...
  },
  {
    ...
    description: 'USGS Streamflow Stations from the National Water Information System (NWIS) Mapper',
    drawOrder: 45,
    legendOrder: -4,
    enabled: false,
    visible: false,
  ...
  },
  {
    ...
    description: 'Eagle County & surrounding county Boundaries',
    drawOrder: 1,
    legendOrder: 3,
    enabled: true,
    visible: true,
  ...
  },
  {
    ...
    description: 'Colorado Department of Public Health & Environment Lake Classifications',
    drawOrder: 2,
    legendOrder: 4,
    enabled: true,
    visible: true,
  ...
  },
  {
    ...
    description: 'Colorado Department of Public Health & Environment Stream Classifications',
    drawOrder: 2,
    legendOrder: 4,
    enabled: false,
    visible: false,
  ...
  },
  {
    ...
    description: 'Land Use Categories from Colorado Decisions Support Systems (CDSS)',
    drawOrder: 3,
    legendOrder: 5,
    enabled: false,
    visible: false,
  ...
  },
  {
    ...
    description: 'HUC12 (Hydrogeologic Unit Codes) Boundaries in and adjacent to Eagle County',
    drawOrder: 4,
    legendOrder: 40,
    enabled: false,
    visible: false,
  ...
  },
  {
    ...
    description: 'Eagle County Zoning Data',
    drawOrder: 6,
    legendOrder: 8,
    enabled: false,
    visible: false,
  ...
  },
  {
    ...
    description: 'Colorado Land Ownership Boundaries',
    drawOrder: 8,
    legendOrder: 8,
    enabled: false,
    visible: false,
  ...
  },
  {
    ...
    description: 'Colorado Land Management Boundaries',
    drawOrder: 8,
    legendOrder: 8,
    enabled: false,
    visible: false,
  ...
  },
  {
    ...
    description: 'Colorado Parks and Wildlife District Boundaries',
    drawOrder: 12,
    legendOrder: 12,
    enabled: false,
    visible: false,
  ...
  },
  {
    ...
    description: 'Terrestrial Crucial Habitat Areas',
    drawOrder: 12,
    legendOrder: 12,
    enabled: false,
    visible: false,
  ...
  },
  {
    ...
    description: 'HUC 10 High Priority Watersheds for Aquatic Species of Greatest Conservation Need',
    drawOrder: 12,
    legendOrder: 12,
    enabled: false,
    visible: false,
  ...
  },
  {
    ...
    description: 'Eagle County Wildfire hazard ratings (Zoom required)',
    drawOrder: 13,
    legendOrder: 13,
    enabled: false,
    visible: false,
  ...
  },
  {
    ...
    description:
      "Flood Hazard Areas identified as part of the National Flood Insurance Program's floodplain management",
    drawOrder: 14,
    legendOrder: 14,
    enabled: false,
    visible: false,
  ...
  },
  {
    ...
    description: 'Developed Areas from the National Land Cover Database (NLCD) (Zoom required)',
    drawOrder: 15,
    legendOrder: 15,
    enabled: false,
    visible: false,
  ...
  },
  {
    ...
    description: 'Vegetated Areas from the National Land Cover Database (NLCD) (Zoom required)',
    drawOrder: 15,
    legendOrder: 15,
    enabled: false,
    visible: false,
  ...
  },
  {
    ...
    description:
      'Colorado National Heritage Program (CNHP) estimate of the primary area required to support the long-term survival of targeted species or natural communities.',
    drawOrder: 16,
    legendOrder: 16,
    enabled: false,
    visible: false,
  ...
  },
  {
    ...
    description:
      'Surface water features; including, lakes, rivers, streams, and wetlands plus an approximate 100 meter buffer around these features.',
    drawOrder: 16,
    legendOrder: 16,
    enabled: false,
    visible: false,
  ...
  },
  {
    ...
    description:
      'Surface water features, including, lakes, rivers, streams, and wetlands plus all contiguous areas that have a wetness index value of 550 or greater',
    drawOrder: 16,
    legendOrder: 16,
    enabled: false,
    visible: false,
  ...
  },
  {
    ...
    description: 'Colorado National Heritage Program (CNHP) Network of Conservation Areas',
    drawOrder: 16,
    legendOrder: 16,
    enabled: false,
    visible: false,
  ...
  //  },
  {
    ...
    description: 'On-Site Wastewater Treatment system permit locations',
    drawOrder: 45,
    legendOrder: 45,
    enabled: false,
    visible: false,
  ...
  },
  {
    ...
    description: 'Colorado Decisions Support Systems (CDSS) Surface Water Structures',
    drawOrder: 30,
    legendOrder: 30,
    enabled: false,
    visible: false,
  ...
  },
  {
    ...
    description: 'Colorado Decisions Support Systems (CDSS) Ground Water Structures',
    drawOrder: 31,
    legendOrder: 31,
    enabled: false,
    visible: false,
  ...
  },
  {
    ...
    description: 'Colorado Decisions Support Systems (CDSS) Reservoir Structures',
    drawOrder: 32,
    legendOrder: 32,
    enabled: false,
    visible: false,
  ...
  },
  {
    ...
    description: 'Colorado Decisions Support Systems (CDSS) Minimum Flow Structures',
    drawOrder: 33,
    legendOrder: 33,
    enabled: false,
    visible: false,
  ...
  },
  {
    ...
    description: 'Colorado Decisions Support Systems (CDSS) Other Water Structures',
    drawOrder: 34,
    legendOrder: 34,
    enabled: false,
    visible: false,
  ...
  },
  {
    ...
    description: 'Major diversion structures in Eagle County',
    drawOrder: 35,
    legendOrder: 35,
    enabled: false,
    visible: false,
  ...
  },
  {
    ...
    description: 'Recreational facilities on Colorado Parks and Wildlife owned properties',
    drawOrder: 45,
    legendOrder: 45,
    enabled: false,
    visible: false,
  ...
  },
  {
    ...
    description: 'Designated trailheads on Colorado Parks and Wildlife properties',
    drawOrder: 45,
    legendOrder: 45,
    enabled: false,
    visible: false,
  ...
  },
  {
    ...
    description: 'Colorado Trail Explorer (COTREX) Trails and Trailheads ',
    drawOrder: 45,
    legendOrder: 45,
    enabled: false,
    visible: false,
  ...
  },
  {
    ...
    description: 'Designated Trails on Colorado Parks and Wildlife properties',
    drawOrder: 45,
    legendOrder: 45,
    enabled: false,
    visible: false,
  ...
  },
  {
    ...
    description: 'Designated Gold Medal Waters In Colorado ',
    drawOrder: 45,
    legendOrder: 45,
    enabled: false,
    visible: false,
...
const ParcelLayers = [
  ...
  },
  {
    ...
    description: 'Eagle County Land Parcel Boundaries (Zoom Required)',
    drawOrder: 5,
    legendOrder: 5,
    enabled: false,
    visible: false,
