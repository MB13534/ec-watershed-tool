...
const LayerItem = ({ active, name, geometryType, onLayerChange, onZoomToLayerChange, spatialData }) => {
  ...
  return (
    <ListItem button>
      ...
      <ListItemSecondaryAction className={classes.secondaryAction}>
        {active && spatialData && (
          //spread a new spatialData to ensure the useEffect sees a change and runs the zoom
          <IconButton onClick={() => onZoomToLayerChange({ ...spatialData })}>
...
const LayerControl = ({ layers = [], open = false, onClose, onLayerChange, onZoomToLayerChange }) => {
  return (
    <div>
      {open && (
        <Box
        ...
        >
          ...
          >
            ...
            <Button variant="contained" disableElevation color="secondary" size="small" onClick={onClose}>
              Hide
            </Button>
          </Box>
          <Divider />
          <List dense>
            ...
            {layers.map(layer => (
              <LayerItem
                ...
                spatialData={layer.spatial_data || null}
              />
            ))}
          </List>
        </Box>
